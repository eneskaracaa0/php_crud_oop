...
class signupConfig{
    ...
    public function insertData(){
        try{
            $stm=$this->dbCnx->prepare('INSERT INTO users firstname=?,lastname=?,address=?');
            $stm->execute(array($this->firstName,$this->lastName,$this->address));
        ...
        public function fetchOne(){
           try{
             $stm = $this->dbCnx->prepare('SELECT id, firstname, lastname FROM users WHERE id = ?');
